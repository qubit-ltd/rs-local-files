...
fn test_rename_parent_durability_failure_reports_renamed() {
    const TEST_NAME: &str = concat!("test_rename_parent_durability_failure_reports_renamed");
...
fn test_rename_native_io_failure_reports_indeterminate() {
    const TEST_NAME: &str = concat!("test_rename_native_io_failure_reports_indeterminate");
