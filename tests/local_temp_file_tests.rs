...
use qubit_local_files::{
    LocalFileSystem, LocalPersistFailureState, LocalPersistMethod, LocalPersistOptions,
    LocalTempFileOptions, RootedLocalFileSystem,
};
...
fn test_local_temp_file_cleanup_failure_retains_resource_for_retry() {
    ...
    fs::write(&path, b"restored").expect("fixture should restore the temporary file");
    temporary
        .cleanup()
