...
# These files contain only normalization for externally timed namespace races,
# live-descriptor failures, random-name collision exhaustion, and counters
# beyond finite portable fixtures. Filesystem calls and ordinary orchestration
# stay in covered files; instrumentation never changes runtime control flow.
